...
function gallery_pics() {
    ...
    while ($stmt -> fetch()) {
        ...
        $display_photos_html .= '<img src="../upload_photos_thumbnail/' .$photo_filename_from_db .'" alt="' .$photo_alttext_from_db .'" class="thumb" data-fn="pildifaili_nimi" data-id="pildi_id">';
