...
//$todaysweekdayhtml="<p> Täna on ". $day_names[$weekday_nr].". Andmed loetakse massiivist.</p>";$weekday_nr=date('w'); 
//$day_names=['pühapäev','esmaspäev','teisipäev','kolmapäev','neljapäev','reede','laupäev'];
//$todaysweekdayhtml="<p> Täna on ". $day_names[$weekday_nr].". Andmed loetakse massiividest.</p>";
